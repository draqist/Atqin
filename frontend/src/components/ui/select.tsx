 ...
 * Manages the state of the select (open/closed, value).
 */
function Select({
  ...props
...
/**
 * Groups related items within the select content.
 */
...
/**
 * The trigger button that toggles the select.
 */
...
/**
 * The content to be displayed within the select dropdown.
 */

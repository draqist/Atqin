        ...
        <h3 className="text-xl font-bold text-slate-900 mb-2">
          {currentCategory
            ? t("empty.categoryTitle", {
                category: t(`categories.${currentCategory}` as any),
              })
            : t("empty.title")}
        </h3>
        <p className="text-slate-500 max-w-md mb-8 leading-relaxed">
          {currentCategory ? t("empty.categoryDesc") : t("empty.desc")}
        </p>
        {currentCategory ? (
          <Button
        ...
        {currentCategory && (
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-slate-900 capitalize">
              {t("search.categoryCollection", {
                category: t(`categories.${currentCategory}` as any),
              })}
            </h1>
            <p className="text-slate-500 text-sm mt-1">
              {t("search.count", { count: filteredBooks.length })}
            </p>
          </div>
        )}

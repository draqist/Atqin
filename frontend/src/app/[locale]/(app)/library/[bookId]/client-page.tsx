                  ...
                  <div className="flex items-center gap-3 text-left">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-slate-500 font-medium">
                        {resource.children?.length} {t("player.videos")} •{" "}
                        {t("player.playlist")}
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex items-start gap-3 px-1">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1.5 text-[11px] text-slate-500 font-medium">
                      ...
                      <span>{t("player.singleVideo")}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col overflow-hidden">
              <h1
                className={cn(
                  ...
                  isArabic && "font-amiri text-base"
                )}
              >
                {isArabic
                  ? bookData?.title_ar || bookData?.title
                  : bookData?.title}
              </h1>
              <span className="text-[10px] text-slate-500 truncate">
                {t("header.readingView")}
              </span>
            </div>
          </div>
          <div>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                >
                  ...
                  <span>{t("actions.viewReflections")}</span>
      ...
      <header className="h-16 px-6 flex items-center justify-between bg-white/80 backdrop-blur-sm border-b border-slate-200/60 z-10 sticky top-0">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            <h1
              className={cn(
                "font-semibold text-slate-900 text-sm md:text-base leading-tight",
                isArabic && "font-amiri text-lg"
              )}
            >
              {isArabic
                ? bookData?.title_ar || bookData?.title
            ...
            <span className="text-xs text-slate-500">
              {isArabic
                ? bookData?.author_ar || bookData?.original_author
              ...
              <div className="p-4 border-b border-slate-100 bg-slate-50/50">
                ...
                <TabsList className="w-full bg-slate-200/50">
                  ...
                  <TabsTrigger value="discuss" className="flex-1 text-xs gap-1">
                    <MessageSquare className="w-3 h-3" /> {t("tabs.discuss")}
                  </TabsTrigger>
                </TabsList>
              </div>
